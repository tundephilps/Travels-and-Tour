...
const Review = () => {
  return (
    <div className="bg-[#FAFAFA] py-6 sm:py-8 lg:py-12">
      <div className="mx-auto lg:px-12 px-4 md:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          <div className="lg:h-[421px] overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
            <img
              src={review}
              loading="lazy"
          ...
          <div className="flex flex-col items-center justify-center sm:items-start bg-white p-8 h-full lg:py-3 ">
            <figure className="max-w-screen-md">
              ...
              <blockquote>
                <p className="text-2xl font-semibold text-[#464D59] dark:text-white flex gap-6">
                  <span>
              ...
              <figcaption className="flex items-center mt-6 space-x-3 rtl:space-x-reverse">
                ...
                <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-300 dark:divide-gray-700">
                  ...
                  <cite className="ps-3 text-sm text-gray-500 dark:text-gray-400 flex flex-row items-center gap-2">
                    Nigeria <img src={ng} />
                  </cite>
                </div>
              </figcaption>
