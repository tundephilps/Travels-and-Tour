    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4 text-center">
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full items-center ">
            <div className=" px-4 py-6 rounded-lg flex flex-col gap-3 items-center">
              <img src={icon1} />
              <h2 className="title-font font-medium text-[16px] text-[#18202F]">
                SIGN UP
              </h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full items-center  lg:pt-12">
            <div className=" px-4 py-6 rounded-lg flex flex-col gap-3 items-center">
              <img src={icon2} />
              <h2 className="title-font font-medium text-[16px] text-[#18202F]">
                BOOK A TRIP
