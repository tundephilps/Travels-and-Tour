...
const Destinations = () => {
  return (
    <div>
      <div className="flex flex-col text-center w-full py-20 items-center">
        <div className="bg-[#FCEAF8] w-[251px] border-[#DC28B7] border-l-2 rounded-md">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-[24px] text-[#464D59] mt-4">
          Get inspired with our amazing trips for you to explore the world
        </p>
      </div>
      ...
      <section className=" py-8 lg:px-12 px-2">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-lg ">
            <div className="flex relative  h-[600px] ">
              <img
